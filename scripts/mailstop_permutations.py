...
if __name__ == '__main__':
    ...
    # Create a dict where key = the index of a character with substitutions and value = an array of characters to sub
    for dummy, stop_row in mail_stops.iterrows():
        ...
        for index, badchars in weak_letters.items():
            permutations = perms_for_character(index, badchars, set(), stop, dict())
