...
projects/wordpress/update-cloud-config.sh || true # if update script found, run before adding to the terraform config file
...
# Update cloud-config in terraform file
rm -rf terraform.log
